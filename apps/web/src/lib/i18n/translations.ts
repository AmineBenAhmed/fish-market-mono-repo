...
const translations: Record<string, Record<Locale, string>> = {
  // ── Header ──
  'header.tagline': {
    en: 'The first platform specialized in selling fresh, frozen and prepared fish in Tunisia',
    fr: 'La première plateforme spécialisée en vente des poissons frais, congelés et préparé en Tunisie',
    ar: 'أول منصة متخصصة في بيع الأسماك الطازجة والمجمدة والمجهزة في تونس',
  },
